...
public class PaymentController {
	...
	public String createOrder() {
		...
		Order order = null;
		try {
			RazorpayClient razorpay = new RazorpayClient("rzp_test_s4RhQkvWvccOYD", 
					"PH42g6qZVVNZmaOJn5ezufec");
	...
	public boolean verifyPayment(@RequestParam  String orderId, @RequestParam String paymentId,
	    ...
	    try {
			...
			RazorpayClient razorpayClient = new RazorpayClient("rzp_test_s4RhQkvWvccOYD", 
	        								"PH42g6qZVVNZmaOJn5ezufec");
